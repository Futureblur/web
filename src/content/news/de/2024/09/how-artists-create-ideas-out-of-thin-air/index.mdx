...
draft: true
type: Tip
cover: autmn-landscape.jpg
coverDescription: Eine friedliche Wiese mit Blick auf eine hügelige Landschaft unter einem trüben Himmel.
url: https://fut.red/6ktMf
---
import Image from "@/components/News/ArticleImage.astro";

import autmnLandscapeImage from './autmn-landscape.jpg';
import museumImage from "./museum.jpeg"
import spiderManImage from "./spider-man-across-the-spider-verse.webp"


# Content ist überall. Warum ist es dann so schwer, neue Ideen zu finden?

<Image src={ autmnLandscapeImage } alt="Eine friedliche Wiese mit Blick auf eine hügelige Landschaft unter einem trüben Himmel.">
	Aufgenommen von Rasul Adasov.
</Image>
...
<Image src={ spiderManImage } alt="Standbild aus dem Animationsfilm Spider-Man: Across the Spider-Verse.">
